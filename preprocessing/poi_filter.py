...
def filter_stop_poi(db_path):
    """Filter interested stops within specific region"""
    lat_min = 59.301280
    lat_max = 59.384970
    lon_min = 18.132843
    lon_max = 18.955033
    ...
    with sqlite3.connect(db_path) as conn:
        ...
        """)
        result = cursor.execute("SELECT COUNT(*) FROM stops_poi").fetchone()
        print(f"Filtered to {result[0]} stops updates in POI area")
